...
@implementation MobileRegisterViewController2 {
...
- (IBAction)next:(ESRedButton *)sender {
    ...
    [memberApi validMobileCode:mobile mobileCode:mobileCodeTf.text success:^{
        ...
        MobileRegisterViewController3 *mobileRegisterViewController3 = [MobileRegisterViewController3 new];
        mobileRegisterViewController3.mobile = mobile;
        mobileRegisterViewController3.mobileCode = mobileCodeTf.text;
        [self.navigationController pushViewController:mobileRegisterViewController3 animated:YES];
