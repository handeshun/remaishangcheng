...
#define kImageDefaultName @"network_error@2x"
...
//    cell.imageView.backgroundColor = UIColorFromRGB(0xF8FCF8);
    if([menu.urlName isKindOfClass:[NSString class]] && [menu.urlName length] > 0) {
        [cell.imageView sd_setImageWithURL:[NSURL URLWithString:menu.urlName] placeholderImage:[UIImage imageNamed:kImageDefaultName]];
    }else{
        [cell.imageView sd_setImageWithURL:@"" placeholderImage:[UIImage imageNamed:kImageDefaultName]];
    }
    return cell;
}
