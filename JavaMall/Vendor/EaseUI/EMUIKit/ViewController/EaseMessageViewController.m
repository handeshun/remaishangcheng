...
{
    //重新组合ext
    NSMutableDictionary *newExt = nil;
    if(ext == nil){
        newExt = [NSMutableDictionary dictionaryWithCapacity:0];
    }else{
        newExt = [NSMutableDictionary dictionaryWithDictionary:ext];
    }
    if([Constants currentMember] != nil) {
        [newExt setObject:[Constants currentMember].userName forKey:@"nickname"];
    }
