...
#define MenuBackgroundColor [UIColor colorWithRed:0 green:0 blue:0 alpha:0.8]
#define MenuLineColor [UIColor colorWithRed:95/255.0 green:100/255.0 blue:104/255.0 alpha:1.0]

#import "DropMenuView.h"

@interface DropMenuViewCell : UITableViewCell
...
@implementation DropMenuViewCell
...
//    layer.position = CGPointMake(self.showContainerView.frame.size.width - 20, 10);
    layer.position = CGPointMake(30, 10);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DropMenuViewCell *cell = [tableView dequeueReusableCellWithIdentifier:optionIdentifier];
    if (!cell) {
        cell = [[DropMenuViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:optionIdentifier];
