...
+ (NSDictionary *)systemInfoDict {
    ...
    if(!systemInfoDict){
        ...
        systemInfoDict = [[NSMutableDictionary alloc] initWithDictionary:@{
...
- (NSString *) deviceName{
    ...
    NSInteger modelIndex = [modelArray indexOfObject:deviceString];
    if(modelIndex < 0 || modelIndex >= [modelNameArray count]){
        return @"";
    }
    return [modelNameArray objectAtIndex:modelIndex];
}
